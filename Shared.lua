...
function MM2.GetPlayerRole(player)
	...
	if MM2.State.SuppressStaleRoles then return "Innocent" end
	if MM2.State.PlayerOutOfRound[player.Name] then return "Innocent" end
	local role = MM2.State.ServerRolesCache[player.Name]
