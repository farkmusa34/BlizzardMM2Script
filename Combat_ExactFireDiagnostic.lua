...
local function FireCombatGun(gun,targetPosition)
	...
	if ExactFireDiagnostic.Enabled and diagnostic then
		...
		print("============================================================")
		print("EXACT FIRE SHOT #"..diagnostic.Id)
		print("Target="..tostring(diagnostic.Player and diagnostic.Player.Name or "?"))
		print("Prediction=60ms horizontal")
		print("BasePosition="..DiagnosticVector3(diagnostic.BasePosition))
		print("BaseVelocity="..DiagnosticVector3(diagnostic.BaseVelocity))
		print("SentTarget="..DiagnosticVector3(targetPosition))

		if firePosition and fireVelocity then
			print("FireMomentPosition="..DiagnosticVector3(firePosition))
			print("FireMomentVelocity="..DiagnosticVector3(fireVelocity))
			print(string.format(
		...
		print("ShooterHRP="..DiagnosticVector3(hrp.Position))
		print("OriginCFramePosition="..DiagnosticVector3(originCFrame.Position))
		print("DestinationCFramePosition="..DiagnosticVector3(destinationCFrame.Position))
		print(string.format(
	...
	if ExactFireDiagnostic.Enabled and diagnostic then
		...
		print("POST-FIRE: 16/33/50/66/100/150/200ms")
		print("------------------------------------------------------------")
